...
if ($action == "add") {
	...
	// $qrystr = db_query();
	mysqli_query($con,"INSERT INTO `tbl_member`(`user_type`, `full_name`, `email`, `password`, `phone`,`address`, `appartment_no`, `city`, `state`, `postal_code`,`bname`,  `baddress`, `bcity`, `bstate`, `bcountry`, `bzip`, `bemail`, `bphone`, `bappartment`,`status`,`block`) VALUES ('$user_type','$full_name','$email','$password','$phone','$address','$appartment_no','$city','$state','$postal_code','$bname','$baddress','$bcity','$bstate','$bcountry','$bzip','$bemail','$bphone','$bappartment','$status','$block')");
	if(mysqli_error($con)){
