...
//	            $mail->Host = 'octo-boss.com';
	            $mail->Host = 'mail.octo-boss.com';
	            $mail->SMTPAuth = true;                               // Enable SMTP authentication
	            $mail->Username = 'info@octo-boss.com'; 
	            $mail->Password = '+qI(Gs@KV9OK';                          // SMTP password
	            $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
	            $mail->Port = 587;
	        }
	        $senderEmail = 'octo-boss.com';                                 // TCP port to connect to
	        $senderName = 'octo-boss.com';                                 // TCP port to connect to
	         $msg = $message['body'];
	         $msg .= '<p><b>Best regards,</b></p>';
	         $msg .= '<p><b>'.'octo-boss.com'.'</b></p>';
...
function sendEmailToAdmin($data, $message) {
	global $con;
	$data['email'] = 'shanibhai7979@gmail.com';
