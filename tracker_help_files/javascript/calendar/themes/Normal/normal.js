...
var new_curr_date=cur_year+5;

var gBegin=[cur_year,cur_month,cur_day];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
cur_year1=cur_year+1;
var gEnd=[new_curr_date,cur_month,cur_day-1];	// calendar date range end at [Year,Month,Date]
...
var gcCalBG="#F88D00";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#7F1100";	// the background color of the inner table, showing as a frame.
...
var gcSatBG="#E96700";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#E96700";	// Sunday background color
